...
- 1.1.1 문서화된 오픈 소스 정책.
- 1.1.2 모든 소프트웨어 공급 담당자가 오픈 소스 정책의 존재를 인식하게 하는 문서화된 절차 (예: 교육, 내부 wiki, 혹은 기타 실질적인 의사소통 방법을 통해).
...
##### 이유 :
오픈 소스 정책을 생성 및 기록하고, 소프트웨어 공급 담당자가 오픈 소스 정책의 존재를 인식하게 하기 위한 조치가 취해지도록 보장하기 위함. 이 절에서는 정책에 포함되어야 할 사항에 대한 요건을 제공하지 않고, 다른 절에서 정책에 대한 요건을 부과할 것이다.
