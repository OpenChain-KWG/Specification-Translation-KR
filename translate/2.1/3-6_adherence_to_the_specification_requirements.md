...
* 3.6.1.1 3.1.4조에서 명시한 프로그램이 이 문서의 모든 요구사항을 충족함을 확인하는 문서
...
조직이 시간이 지나도 적합성을 유지함을 주장하려면 프로그램이 최근의 표준으로 유지되어야 한다. 이 요구사항은 조직이 시간이 지난 후에도 계속적으로 프로그램 적합성을 주장하려 할 때, 프로그램의 지원 프로세스와 통제가 약화되지 않았음을 보장해주기 위함이다. 
