...
프로그램 참여자가 각자의 역할과 책임에 대해 충분한 수준의 역량 확보가 되었음을 보장하기 위해서이다.
...
3.1.3.1 프로그램 참여자에 대해 다음 사항에 대한 인식을 평가하였음을 나타내는 문서 : 프로그램의 목표, 프로그램 내에서의 참여자 기여 방법, 프로그램을 준수하지 않을 때의 시사점
